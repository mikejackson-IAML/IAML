...
>(({ className, value = 0, thresholds = { warning: 70, critical: 90 }, invertColors = false, indicatorClassName, ...props }, ref) => {
  ...
  if (invertColors) {
    ...
    if (value < 100 - thresholds.critical) {
      colorClass = 'bg-red-500';
    } else if (value < 100 - thresholds.warning) {
      colorClass = 'bg-amber-500';
    }
  }
